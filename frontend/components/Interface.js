...
// 0x56fa30827c75bc6C9316623Fb375783FC63132eC
// 0x3453665820295C20CDA346CA4F1F8Aa2c852bA44
// 0x8Fba2453fb570794d81d2C64FA53521874307246

const tornadoAddress = "0x8Fba2453fb570794d81d2C64FA53521874307246";
            ...
            <nav className="navbar navbar-nav fixed-top bg-dark text-light">
                {
                    !!account ? (
                        ...
                        <div className="container">
                            <div className="navbar-left"><h5>Crypto-Mixer</h5></div>
                            <div className="navbar-right">
                                <button 
